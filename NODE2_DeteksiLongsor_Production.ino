...
unsigned int idlePeriodInSec = 5;
...
////////////////// PROGRAM SENSOR /////////////////////
  ...
  str1 = String(curah_hujan);
  str1.toCharArray(dataHujan,5);
  str2 = String(rawGyro.XAxis);
  str2.toCharArray(gyroXAxis,10);
  str3 = String(rawGyro.YAxis);
  str3.toCharArray(gyroYAxis,10);
  str4 = String(rawGyro.ZAxis);
  str4.toCharArray(gyroZAxis,10);
  str5 = String(rawAccel.XAxis);
  str5.toCharArray(accelXAxis,10);
  str6 = String(rawAccel.YAxis);
  str6.toCharArray(accelYAxis,10);
  str7 = String(rawAccel.ZAxis);
  str7.toCharArray(accelZAxis,10);
...
////////////////// SYNTAX KIRIM DATA /////////////////////
      ...
      sprintf(final_str, "/e.php?H=%s&GX=%s&GY=%s&GZ=%s&AX=%s&AY=%s&AZ=%s",dataHujan,gyroXAxis,gyroYAxis,gyroZAxis,accelXAxis,accelYAxis,accelZAxis);
